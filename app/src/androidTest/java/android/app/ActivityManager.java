 ...
 * For instance, {@link ActivityManager#isLowRamDevice() isLowRamDevice()}
 * enables your app to detect whether it is running on a low-memory device,
 * and behave accordingly.
 * {@link ActivityManager#clearApplicationUserData() clearApplicationUserData()}
...
public class ActivityManager {
    ...
    public static class StackId {
         ...
         * multi-window mode.
         * @see ActivityManager#supportsMultiWindow
         */
    ...
    public static class RecentTaskInfo implements Parcelable {
         ...
         * {@link Activity#setTaskDescription(TaskDescription)}.
         */
     ...
     * the {@link Manifest.permission#INTERACT_ACROSS_USERS_FULL} permission.
     * @param maxNum The maximum number of entries to return in the list.  The
     * actual number returned may be smaller, depending on how many tasks the
     * user has started and the maximum number the system can remember.
     * @param flags Information about what to return.  May be any combination
     ...
     * See {@link ActivityManager#getAppTasks()}
     */
